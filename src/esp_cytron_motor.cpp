...
esp_cytron_motor :: Setup(esp_cytron_type device_type, uint8_t pin1, uint8_t pin2)
{
	switch (device_type) {
...
esp_cytron_motor :: Write(esp_cytron_type device_type, uint8_t state, uint8_t pwm)
{
	switch (device_type) {
	case MOTOR_CHANNEL_0: {
...
esp_cytron_motor :: Read(esp_cytron_type device_type)
{
	switch (device_type) {
	case ENCODER_CHANNEL_0:
